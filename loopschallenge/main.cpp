...
void number_list_main(char &selection);
void selection_main(bool &executing, char &selection, vector<int> &list, int &number, double &mean, int &min, int &max);
...
int main() {
  ...
  while (!executing) {
    ...
    number_list_main(selection);
    selection_main(executing, selection, list, number, mean, min, max);
